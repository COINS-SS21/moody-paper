...
\title*{Flow Emotion Recognition\\ Collaborative Innovation Networks}
% Use \titlerunning{Short Title} for an abbreviated version of
% your contribution title if the original one is too long
\author{Humpe Lukas\inst{1,2} \and
Simon Friedrich-Murillo\inst{1,3} \and
Janik Muires\inst{1,4}}
\authorrunning{Humpe et. al.}

\institute{University of Cologne, Albertus-Magnus-Platz, 50923 Cologne, Germany  \and 
\email{lhumpe@smail.uni-koeln.de} \and
\email{murillo@smail.uni-koeln.de} \and
\email{muires@smail.uni-koeln.de}
}
